...
public class MergeEmpResponseElementImpl extends SDODataObject implements MergeEmpResponseElement {

   public static String SDO_URI = "http://sdo.sample.service/types/";

   public MergeEmpResponseElementImpl() {}

//   public Type getType() {
//      if(type == null){
//         Type lookupType = HelperProvider.getTypeHelper().getType(SDO_URI, "MergeEmpResponseElement");
//         setType(lookupType);
//      }
//      return type;
//   }
