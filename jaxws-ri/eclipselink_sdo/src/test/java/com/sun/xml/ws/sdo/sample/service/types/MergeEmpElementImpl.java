...
public class MergeEmpElementImpl extends SDODataObject implements MergeEmpElement {

   public static String SDO_URI = "http://sdo.sample.service/types/";

   public MergeEmpElementImpl() {}

//   public Type getType() {
//      if(type == null){
//         Type lookupType = HelperProvider.getTypeHelper().getType(SDO_URI, "MergeEmpElement");
//         setType(lookupType);
//      }
//      return type;
//   }
