...
public class UpdateEmpResponseElementImpl extends SDODataObject implements UpdateEmpResponseElement {

   public static String SDO_URI = "http://sdo.sample.service/types/";

   public UpdateEmpResponseElementImpl() {}

//   public Type getType() {
//      if(type == null){
//         Type lookupType = HelperProvider.getTypeHelper().getType(SDO_URI, "UpdateEmpResponseElement");
//         setType(lookupType);
//      }
//      return type;
//   }
