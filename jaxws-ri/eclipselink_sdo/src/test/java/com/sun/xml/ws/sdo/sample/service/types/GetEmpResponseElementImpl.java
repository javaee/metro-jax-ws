...
public class GetEmpResponseElementImpl extends SDODataObject implements GetEmpResponseElement {

   public static String SDO_URI = "http://sdo.sample.service/types/";

   public GetEmpResponseElementImpl() {}

//   public Type getType() {
//      if(type == null){
//         Type lookupType = HelperProvider.getTypeHelper().getType(SDO_URI, "GetEmpResponseElement");
//         setType(lookupType);
//      }
//      return type;
//   }
