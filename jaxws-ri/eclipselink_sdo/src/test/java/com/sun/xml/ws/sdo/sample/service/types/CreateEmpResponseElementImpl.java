...
public class CreateEmpResponseElementImpl extends SDODataObject implements CreateEmpResponseElement {

   public static String SDO_URI = "http://sdo.sample.service/types/";

   public CreateEmpResponseElementImpl() {}

//   public Type getType() {
//      if(type == null){
//         Type lookupType = HelperProvider.getTypeHelper().getType(SDO_URI, "CreateEmpResponseElement");
//         setType(lookupType);
//      }
//      return type;
//   }
