...
public class FindClerksElementImpl extends SDODataObject implements FindClerksElement {

   public static String SDO_URI = "http://sdo.sample.service/types/";

   public FindClerksElementImpl() {}

//   public Type getType() {
//      if(type == null){
//         Type lookupType = HelperProvider.getTypeHelper().getType(SDO_URI, "FindClerksElement");
//         setType(lookupType);
//      }
//      return type;
//   }
