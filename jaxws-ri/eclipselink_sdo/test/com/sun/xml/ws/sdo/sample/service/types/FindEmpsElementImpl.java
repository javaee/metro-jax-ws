...
public class FindEmpsElementImpl extends SDODataObject implements FindEmpsElement {

   public static String SDO_URI = "http://sdo.sample.service/types/";

   public FindEmpsElementImpl() {}

//   public Type getType() {
//      if(type == null){
//         Type lookupType = HelperProvider.getTypeHelper().getType(SDO_URI, "FindEmpsElement");
//         setType(lookupType);
//      }
//      return type;
//   }
