...
//        Iterator ports = service.getPorts();
    ...
    public List<String> getJAXWSClassComment(){
        return getJAXWSClassComment(WSVersion, targetVersion);
    }
    
    public static List<String> getJAXWSClassComment(String wsVersion, String targetVersion) {
        List<String> comments = new ArrayList<String>();
        comments.add("This class was generated by the JAXWS SI, do not edit.\n");
        comments.add("Contents subject to change without notice.\n");
