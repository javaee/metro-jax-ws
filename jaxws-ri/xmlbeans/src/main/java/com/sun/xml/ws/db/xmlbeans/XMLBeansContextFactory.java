...
/**
 * XMLBeansContextFactory
 * 
 * @author shih-chang.chen@oracle.com
 */
public class XMLBeansContextFactory extends BindingContextFactory {
    ...
    protected BindingContext newContext(BindingInfo bi) {
        return new XMLBeansContext(bi);
    }

    @Override
    protected boolean isFor(String str) {
        return (str.equals("xmlbeans") ||
                str.equals("apache.xmlbeans")||
                str.equals(this.getClass().getName())||
                str.equals("org.apache.xmlbeans"));
    }
