...
/**
 * {@link com.sun.xml.ws.api.server.SDDocument} implmentation.
 *
 * <p>
 * This extends from {@link com.sun.xml.ws.api.server.SDDocumentSource} so that
 * JAX-WS server runtime code can use {@link com.sun.xml.ws.api.server.SDDocument}
 * as {@link com.sun.xml.ws.api.server.SDDocumentSource}.
 *
...
public class MetadataDocument extends SDDocumentSource implements SDDocument {
     ...
     * @param portTypeName
     *      The information about the port of {@link com.sun.xml.ws.api.server.WSEndpoint} to which this document is built for.
    ...
    /**
     * {@link com.sun.xml.ws.api.server.SDDocument.Schema} implementation.
     *
     * @author Kohsuke Kawaguchi
     */
