...
public class ExternalMetadataFeature extends WebServiceFeature {
    ...
    private static final String ID = "org.jvnet.ws.databinding.ExternalMetadataFeature";
    ...
    public MetadataReader getMetadataReader(ClassLoader classLoader) {
        return enabled ? new ExternalMetadataReader(files, resourceNames, classLoader, true) : null;
    }
