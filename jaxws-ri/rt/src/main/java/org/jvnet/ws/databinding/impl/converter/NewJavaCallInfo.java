...
class NewJavaCallInfo implements com.oracle.webservices.api.databinding.JavaCallInfo {
    private final JavaCallInfo jci;
    
    public NewJavaCallInfo(JavaCallInfo jci) {
        this.jci = jci;
    }
