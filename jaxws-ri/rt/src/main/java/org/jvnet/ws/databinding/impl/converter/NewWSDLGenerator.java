...
public class NewWSDLGenerator implements com.oracle.webservices.api.databinding.WSDLGenerator {
    ...
    public WSDLGenerator inlineSchema(boolean inline) {
        return new NewWSDLGenerator(wsdlGenerator.inlineSchema(inline));
    }

    @Override
    public WSDLGenerator property(String name, Object value) {
        return new NewWSDLGenerator(wsdlGenerator.property(name, value));
    }

    @Override
    public void generate(WSDLResolver wsdlResolver) {
        wsdlGenerator.generate(new OldWSDLResolver(wsdlResolver));
    }
