...
public class OldWSDLGenerator implements org.jvnet.ws.databinding.WSDLGenerator, org.jvnet.ws.databinding.Databinding.WSDLGenerator {
    ...
    public WSDLGenerator inlineSchema(boolean inline) {
        return new OldWSDLGenerator(wsdlGenerator.inlineSchema(inline));
    }

    @Override
    public WSDLGenerator property(String name, Object value) {
        return new OldWSDLGenerator(wsdlGenerator.property(name, value));
    }

    @Override
    public void generate(WSDLResolver wsdlResolver) {
        wsdlGenerator.generate(new NewWSDLResolver(wsdlResolver));
    }

    @Override
    public void generate(File outputDir, String name) {
        wsdlGenerator.generate(outputDir, name);
    }
