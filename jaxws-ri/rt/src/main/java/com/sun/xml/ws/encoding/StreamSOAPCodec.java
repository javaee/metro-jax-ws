...
public abstract class StreamSOAPCodec implements com.sun.xml.ws.api.pipe.StreamSOAPCodec, RootOnlyCodec {
    ...
    public void decode(InputStream in, int contentLength, String contentType, Packet packet) throws IOException {
        decode(in, contentLength, contentType, packet, new AttachmentSetImpl());
    }
    ...
    public void decode(InputStream in, String contentType, Packet packet, AttachmentSet att ) throws IOException {
        decode(in, -1, contentType, packet, att);
    }
    
    public void decode(InputStream in, int contentLength, String contentType, Packet packet, AttachmentSet att ) throws IOException {
        ...
        packet.setMessage(streamDecoder.decode(in, contentLength, charset, att, soapVersion));
    }
