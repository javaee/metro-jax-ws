 ...
 * holder.
 */
package com.sun.xml.ws.databinding;
 ...
 * @author Chen
 */
public class DatabindingModeFeatureTest extends TestCase {
    ...
    public void testDatabindingAF() throws Exception {
        DatabindingMode a = A.class.getAnnotation(DatabindingMode.class);
