...
REM
REM $Id: wsimport.bat,v 1.15 2007-05-30 01:03:27 ofung Exp $
REM
...
"%JAVA_HOME%\bin\java" -Djava.endorsed.dirs="%JAVA_ENDORSED_DIRS%" -cp "%CLASSPATH%" com.sun.tools.ws.WsImport %CMD_LINE_ARGS% 
