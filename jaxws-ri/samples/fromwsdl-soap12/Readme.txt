soap1.2 fromwsdl sample demonstrates the WSDL->Java programming model.

* The endpoint has operation Addnumbers()
...
* etc - configuration files
    ...
    * build.properties, deploy-targets.xml ant script to deploy the endpoint
      war file. Notice that extension=true in build.properties, because soap1.2
      is supported via extension mechanism by wsimport
