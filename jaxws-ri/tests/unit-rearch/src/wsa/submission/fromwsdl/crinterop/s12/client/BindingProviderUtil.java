...
public class BindingProviderUtil {
    ...
    private static final String ENDPOINT_ADDRESS = "http://localhost:/jaxrpc-wsa_submission_fromwsdl_crinterop_s12/member";
    private static final String NON_ANONYMOUS_ENDPOINT_ADDRESS = "http://localhost:/jaxrpc-wsa_fromwsdl_crinterop_s12/nonanonymous";
