...
public class TestConstants {
    public static final String NOTIFY_IN_NOACTION = "http://foobar.org/AddNumbers/notify";
    ...
    public static final String ADD_NUMBERS_FAULT_NOACTION = "http://foobar.org/AddNumbers/addNumbersNoAction/Fault/AddNumbersException";
    ...
    public static final String ADD_NUMBERS_IN_SOAPACTION = "http://example.com/soapaction";
    public static final String ADD_NUMBERS_OUT_SOAPACTION = "http://foobar.org/AddNumbers/addNumbersSOAPActionResponse";
    ...
    public static final String ADD_NUMBERS_FAULT1_OUT_ACTION = "foutput1";        
    ...
    public static final String ADD_NUMBERS_FAULT2_OUT_ACTION = "foutput2";
