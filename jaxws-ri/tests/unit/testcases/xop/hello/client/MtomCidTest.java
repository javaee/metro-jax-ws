...
public class MtomCidTest extends TestCase {
    // endpoint adddress of the web service

    private static final String _address = "http://localhost:/jaxrpc-xop_hello/hello";
    ...
    public static void main(String args[]) throws Exception {
        MtomCidTest t = new MtomCidTest();
        t.testEscapedMtomCid();
        t.testNonEscapedMtomCid();
        t.testIndigoMtomStyleMessage();
    }
